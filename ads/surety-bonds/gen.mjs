...
const ads = [
 { file:'Main', tag:'AUTO DEALERS', amount:'$25,000', label:'Oklahoma Used Motor Vehicle Dealer Bond', hook:'Dealer bond due? Done today.',
   body:'Required by the Used Motor Vehicle, Dismantler and Parts Commission before you can license or renew. Send your dealer name and license number, we quote, bind and email the sealed bond, most the same day.',
   chips:['Used and wholesale dealers','Rebuilders: $15,000','Most bonds issued same day'] },
 { file:'Contractor', tag:'CONTRACTORS', amount:'$5,000', label:'Oklahoma CIB Contractor License Bond', hook:'Get licensed. Get bonded. Get to work.',
   body:'Electrical, plumbing and mechanical contractors licensed by the Construction Industries Board, and registered roofers, need a $5,000 continuous bond in the license holder&#39;s name. Pair it with the general liability the board also requires.',
 ...
 { file:'Title', tag:'CAR TITLES', amount:'No title?', label:'Oklahoma Lost Title Bond (bonded title)', hook:'Lost the title? Bond it. Drive it.',
   body:'Service Oklahoma accepts a title bond when the original title is lost, never transferred or missing. Bring the vehicle value and VIN, we set the bond amount (typically 1.5x the value) and issue the three year bond.',
   chips:['Cars, trucks, trailers','Three year term','Amount set by vehicle value'] },
...
<div style="width:1200px;height:628px;position:relative;overflow:hidden;background:${PAPER};color:${INK};display:flex">
  <div style="position:absolute;left:-140px;top:-40px;width:600px;height:760px;background:${RED};transform:skewX(-12deg)"></div>
  <div style="position:absolute;left:420px;top:-40px;width:36px;height:760px;background:${NAVY};transform:skewX(-12deg)"></div>
  <div style="position:relative;width:400px;padding:44px 0 44px 44px;display:flex;flex-direction:column;justify-content:space-between;color:#FFFFFF">
    <div style="font-family:'Archivo',Arial,sans-serif;font-weight:900;font-size:16px;letter-spacing:4px">${a.tag}</div>
    <div style="display:flex;flex-direction:column;gap:6px">
      <div style="font-family:'Anton',Impact,sans-serif;font-size:${a.amount.length>8?'72px':'96px'};line-height:0.95;letter-spacing:-1px;max-width:330px">${a.amount}</div>
...
<div style="width:1200px;height:628px;position:relative;overflow:hidden;background:${NAVY};color:#FFFFFF;display:flex;flex-direction:column;justify-content:space-between;padding:48px 56px;box-sizing:border-box">
  ...
  <div style="display:flex;align-items:flex-end;gap:40px">
    ...
    <div style="display:flex;flex-direction:column;gap:12px;padding-bottom:14px">
      ...
      <div style="font-size:18px;line-height:1.4;opacity:0.9;max-width:520px">Required before the Used Motor Vehicle, Dismantler and Parts Commission licenses or renews you. Send name and license number, get the sealed bond by email.</div>
    </div>
  </div>
  <div style="display:flex;justify-content:space-between;align-items:center">
...
<div style="width:1200px;height:628px;position:relative;overflow:hidden;background:#FFFFFF;color:${INK};display:grid;grid-template-columns:repeat(2, minmax(0, 1fr));box-sizing:border-box">
  <div style="padding:52px 40px 52px 60px;display:flex;flex-direction:column;justify-content:space-between;border-right:14px solid ${RED}">
    ...
    <div style="font-family:'Anton',Impact,sans-serif;font-size:64px;line-height:0.98">Dealer bond due?<br><span style="color:${RED}">Done today.</span></div>
  ...
  <div style="padding:52px 60px 52px 48px;display:flex;flex-direction:column;justify-content:space-between;background:${PAPER}">
    ...
    <div style="display:flex;flex-direction:column;gap:16px">
      ...
      <ul style="margin:0;padding:0;list-style:none;display:flex;flex-direction:column;gap:8px;font-weight:700;font-size:16px;color:${NAVY}">
        <li>Used and wholesale dealers</li><li>Rebuilders: $15,000</li><li>Most bonds issued same day</li>
      </ul>
    </div>
